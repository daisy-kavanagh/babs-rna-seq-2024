---
layout: page
title: Week 7A - Differential Expression Analysis
---

Week 7A - Differential gene expression (DGE) analysis
====================================================
...
Please download this [script](https://github.com/daisy-kavanagh/babs-rna-seq-2025/blob/gh-pages/metadatafiles/merge_abundance_files.sh) using `wget`. In the main folder that you have your kallisto results.
        ...
        $ wget https://github.com/daisy-kavanagh/babs-rna-seq-2026/raw/gh-pages/metadatafiles/merge_abundance_files.sh 
